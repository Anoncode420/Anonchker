...
import threading
stopuser = {}
token = '8168612113:AAFh56YVVVrrtAGGfCRhSdm8LurXufeCABE'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥  ‌", url="https://t.me/mero_221")
			contact_button = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ‌", url="https://t.me/ccmero")
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
		...
		ahmed = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ‌", url="https://t.me/ccmero")
		keyboard.add(contact_button, ahmed)
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥  ‌", url="@mero_221")
		ahmed = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ‌", url="https://t.me/ccmero")
		keyboard.add(contact_button, ahmed)
